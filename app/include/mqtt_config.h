...
#define MQTT_HOST         "a1layga4ANI.iot-as-mqtt.cn-shanghai.aliyuncs.com" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
