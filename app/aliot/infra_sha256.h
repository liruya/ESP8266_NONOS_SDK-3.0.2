...
#define SHA256_SHORT_BLOCK_LENGTH       (SHA256_BLOCK_SIZE - 8)
#define SHA256_DIGEST_STRING_LENGTH     (SHA256_DIGEST_SIZE * 2 + 1)
...
void utils_hmac_sha256_hex(const char *msg, int msg_len, const char *key, int key_len, char output[SHA256_DIGEST_SIZE]);

void utils_hmac_sha256(const char *msg, int msg_len, const char *key, int key_len, char output[SHA256_DIGEST_SIZE*2]);
