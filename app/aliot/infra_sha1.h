...
void utils_hmac_sha1_hex(const char *msg, int msg_len, const char *key, int key_len, char output[SHA1_DIGEST_SIZE]);

void utils_hmac_sha1(const char *msg, int msg_len, const char *key, int key_len, char output[SHA1_DIGEST_SIZE*2]);
