...
void utils_hmac_md5_hex(const char *msg, int msg_len, const char *key, int key_len, char output[MD5_DIGEST_SIZE]);

void utils_hmac_md5(const char *msg, int msg_len, const char *key, int key_len, char output[MD5_DIGEST_SIZE*2]);
